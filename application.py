...
from routes.colors_routes import results_blueprint
...
def register_blueprints(app):
    ...
    colors_service_blueprint = Blueprint('colors-service', __name__, url_prefix='/colors-service')
    colors_service_blueprint.register_blueprint(results_blueprint)

    app.register_blueprint(colors_service_blueprint)